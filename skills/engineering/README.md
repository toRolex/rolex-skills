...
- **[prototype](./prototype/SKILL.md)** — 构建一次性原型来回答设计问题。
- **[diagnosing-bugs](./diagnosing-bugs/SKILL.md)** — 困难 bug 的诊断循环：复现→最小化→假设→插桩→修复→回归测试。
- **[research](./research/SKILL.md)** — 针对高可信度一手资料调查问题，产出带引用的 Markdown 文件。
- **[tdd](./tdd/SKILL.md)** — 红-绿-重构循环的测试驱动开发。
